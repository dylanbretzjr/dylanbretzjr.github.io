...
To view the full implementation and source code, visit [this project's repository](https://github.com/dylanbretzjr/mc-trading-hall-db){target="_blank" rel="noopener"} on GitHub.
...
[Villagers](https://minecraft.wiki/w/Villager){target="_blank" rel="noopener"} are non-playable characters that live in villages and can be assigned different [professions](https://minecraft.wiki/w/Villager_professions){target="_blank" rel="noopener"}, such as armorer, farmer, or librarian. Players can trade with villagers that have a profession using emeralds as currency to buy and sell items.
...
One of the most valuable professions is the [librarian](https://minecraft.wiki/w/Librarian){target="_blank" rel="noopener"}. Not only can you easily get lots of emeralds by selling them paper, but you can also buy enchanted books, which are used to enhance armor, tools, and weapons. Having a good supply of emeralds and enchanted books can be a real game changer, which makes trading with librarians very useful.

However, finding a librarian with a specific enchantment can be _tedious_ ([if you know, you know](https://www.reddit.com/r/Minecraft/comments/1039ybr/i_hate_librarians/ 'r/Minecraft | "I hate librarians"'){target="_blank" rel="noopener"}).

Currently, librarian enchanted book trades are randomly selected from a [set of 40 enchantments](https://minecraft.wiki/w/Enchanting#Summary_of_enchantments){target="_blank" rel="noopener"}, and each librarian can offer up to 4 enchanted book trades. In addition, both the enchantment level and the cost in emeralds are randomly determined.
...
- **CLI tool for updating existing trades**---Support updating existing trade records to reflect discounted prices from [curing zombified villagers](https://minecraft.wiki/w/Zombie_Villager#Curing){target="_blank" rel="noopener"}.
