...
In this case study, I used Python to analyze historical bike-share data from Chicago to understand **how different types of customers used bikes differently** and what those differences suggest for converting casual riders into annual members.
...
In this case study, I analyzed 12 months of bike-share trip data from Chicago to understand how **annual members** and **casual riders** use bikes differently.

The results show clear, consistent differences:

- **Members** account for most rides overall and show strong weekday commuter patterns, with clear peaks around 8 a.m. and 5 p.m.
- **Casual riders** are more active during warmer months, ride more on weekends, take slightly longer trips, and account for a larger share of round trips, suggesting more leisure-oriented usage.
- **Geography differs significantly:** Casual riders tend to cluster near the lakeshore, while members are more dispersed throughout the city.

These findings support strategies focused on converting casual riders during peak riding season, offering weekend/seasonal membership options, and prioritizing areas with high casual rider volume.
